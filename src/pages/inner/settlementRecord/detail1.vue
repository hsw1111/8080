            ...
            <th class="out">
              ...
              <!-- <div class="grid"> -->
                 ...
                 <div class="item auth">
                   ...
                   <div class="list_manage">运营管理费</div>
                    <div class="list">
             ...
             <td data-v-3b262524="" class="dateTime">总计</td>
              ...
              <td data-v-3b262524="" class="out">
                  <div data-v-3b262524="" class="grid">
                      ...
                      <div data-v-3b262524="" class="item auth">
                          <div data-v-3b262524="" class="list_foot">
                              <div data-v-3b262524="" class="cell_foot"></div>
                              <div data-v-3b262524="" class="cell_foot"></div>
                              <div data-v-3b262524="" class="cell_foot">{{sumData.summanagepay}}</div>
                          </div>
                      </div>
                  </div>
              </td>
